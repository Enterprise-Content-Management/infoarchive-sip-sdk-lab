...
----
<1> All SIP SDK jars are stored in the Central Repository
<2> The SIP SDK Maven coordinates (Group/Artifact/Version or GAV). We tested this lab with
...
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSip.java[tags=manifest]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/Person.java[tags=pojo]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSip.java[tags=conversion]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSipByTemplate.java[tags=conversion]
----
<1> The fixed header
<2> The fixed footer
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSip.java[tags=generate]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSipWithContent.java[tags=extraction]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSipWithContentHashing.java[tags=hashing]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/MyFirstSips.java[tags=generate]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/SegmentationStrategies.java[tags=default]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/SegmentationStrategies.java[tags=combining]
----
...
[source,java,indent=0]
----
include::{sourcedir}/presentation/java/com/opentext/ia/sipsdk/presentation/SegmentationStrategies.java[tags=custom]
----
...
can even use the SIP SDK to configure the holding for you. We will not cover ingestion in this presentation; see the
...
* OpenText InfoArchive SIP SDK makes SIP generation and ingestion easy as pie
